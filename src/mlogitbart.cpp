...
// constructor
mlogitbart::mlogitbart(size_t ik):bart(100*ik), k(ik), mpi(), mdi() {}
mlogitbart::mlogitbart(size_t ik, size_t im):bart(m*ik), k(ik), mpi(), mdi() {} // construct m by k trees, im-th tree for class ik is t[im*k + ik]


void mlogitbart::setdata(size_t p, size_t n, double *x, double *y, int *nc)
{
...
// --------------------------------------------------
void mlogitbart::predict(size_t p, size_t n, double *x, double *fp)
//uses: m,t,xi
{
